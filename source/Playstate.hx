...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		var potenteTxt:FlxText = new FlxText(5, 5, "Port by TheDivergentLuna", 16);
        potenteTxt.setFormat(Paths.font("vcr.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
        potenteTxt.borderSize = 1.25;
        potenteTxt.cameras = [camHUD];
        add(potenteTxt);
